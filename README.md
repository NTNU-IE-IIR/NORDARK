...
## User Manual
The User Manual can be found in the Document-folder: [NORDARK_Digital_Twin_User_Manual v1.0.pdf](https://github.com/NTNU-IE-IIR/NORDARK/blob/main/Documentation/NORDARK_Digital_Twin_User_Manual%20v1.0.pdf). The User Manual is writteh in LaTeX (using Overleaf). The source for the document can be found in the same Documentation-folder.
