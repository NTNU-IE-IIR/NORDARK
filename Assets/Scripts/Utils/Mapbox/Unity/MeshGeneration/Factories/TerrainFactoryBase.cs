...
namespace Mapbox.Unity.MeshGeneration.Factories
{
	public class TerrainFactoryBase : AbstractTileFactory
	{
		...
		protected CustomTerrainDataFetcher DataFetcher;

		public CustomTerrainDataFetcher GetFetcher()
		{
			return DataFetcher;
		}
		...
		protected override void OnInitialized()
		{
			...
			DataFetcher = ScriptableObject.CreateInstance<CustomTerrainDataFetcher>();
			DataFetcher.DataRecieved += OnTerrainRecieved;
			DataFetcher.FetchingError += OnDataError;
		}
