...
Shader "CTI HDRP/Billboard HSLS"
{
    Properties
    {
        _HueVariation("Color Variation (RGB) Strength (A)", Color) = (0.9, 0.5, 0, 0.1)
        ...
        _VerticalScale("Vertical Scale", Float) = 2
...
float _VerticalScale;
                ...
                // Shared Graph Node Functions
                    ...
                    #include "Includes/CTI_HDRP_BillboardVertex_HLSL.hlsl"
...
CTIBillboard_float(IN.ObjectSpacePosition, float3(1,1,1), float3(1,1,1), IN.uv0, IN.uv1, _WindStrength, _WindPower, positionOut, normalOut, tangentOut, uvOut, colorVariation);
...
// HueVariation
albedoAlpha.rgb = lerp(albedoAlpha.rgb, (albedoAlpha.rgb + _HueVariation.rgb) * 0.5, IN.uv0.z * _HueVariation.a);
        ...
        //-------------------------------------------------------------------------------------
            ...
            AttributesMesh ApplyMeshModification(AttributesMesh input, float3 timeParameters)
            {
                ...
                input.normalOS = vertexDescription.VertexNormal;
                input.tangentOS.xyz = vertexDescription.VertexTangent;
input.uv0.xyz = vertexDescription.VertexUV;
